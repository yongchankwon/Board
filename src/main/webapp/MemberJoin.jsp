...
<form class="row g-3" method="post" action="/MemberJoin.do" >
  <div class="col-md-6">
    ...
    <input type="email" class="form-control" id="inputEmail4"  placeholder=" exmple@exmple.com" name="email">
  </div>
  <div class="col-md-6">
...
<!--     <label for="inputAddress2" class="form-label">주소</label>
    <input type="text" class="form-control" id="inputAddress" placeholder="주소를 검색해주세요" name="addr1">
  </div>
  <div class="col-12">
    <label for="inputAddress2" class="form-label">상세주소</label>
    <input type="text" class="form-control" id="inputAddress2" placeholder="상세주소를 입력해주세요" name="addr2">
  </div>
  <div class="col-md-3">
